        ...
        <div id="admin">
          ...
          <div class="BgTickets" id="effectblue">
              <div class="TicketsHeader" id="effectteal">
                  ...
                  <a href='index.php?page2=Faq.php'><div class="faq" id="effectlblue"><h3 class="faqh">FAQ</h3></div></a>
                  <a href='index.php?page2=contact.php'><div class="CreateTicket" id="effectlblue"><h3 class="CreateText">Contact via Email</h3></div></a>
              </div>
            ...
            $query = "SELECT TicketID, Title, Opening_Date, Status, admin.Admin_Name, admin.ImagePath FROM " . $TableName . "
			 LEFT JOIN admin ON ticket.AdminID = admin.AdminID WHERE UserID = ? ORDER BY TicketID DESC ";
